...
1. 🌎 Create a **quality instruction corpus that represents the different varieties of Spanish** that allows us to train inclusive models.
2. ✅ Create a **public leaderboard of LLMs in Spanish** that allows us to standardize how to evaluate and compare the different models in Spanish and co-official languages.
