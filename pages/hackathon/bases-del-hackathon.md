...
target="_blank">hackathon-somos-nlp-2023</a> para que aparezca en la leaderboard y todo el mundo pueda verla y darle like. Si quieres compartir tu dataset en redes utiliza el hashtag #HackathonSomosNLP y menciona a Somos NLP para que le demos más visibilidad.
...
- Lunes 20: <a href="hackathon/etiquetado-de-datos-con-argilla" target="_blank">Taller práctico: Fine-tuning de grandes modelos de lenguaje</a> impartido por Manu Romero, el mayor contribuidor del Hub de Hugging Face. *(Grabación ya disponible)*
- En español o multilingüe.
...
target="_blank">hackathon-somos-nlp-2023</a> para que aparezca en la leaderboard y todo el mundo pueda verlo y darle like. Si quieres compartir tu modelo en redes utiliza el hashtag #HackathonSomosNLP y menciona a Somos NLP para que le demos más visibilidad.
