...
- Upload the final file to a **PRIVATE** dataset in [huggingface.co/somosnlp-hackathon-2026](https://huggingface.co/somosnlp-hackathon-2026) with the exam name. If you are not part of the organization, join with this [invite](https://huggingface.co/somosnlp-hackathon-2026).
