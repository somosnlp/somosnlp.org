...
- Extraia as perguntas e respostas e crie um arquivo final em formato **JSON** (exemplo a seguir).
    ...
    - Repositório GitHub com o código do workshop: [amayuelas/corpus-automation](https://github.com/amayuelas/corpus-automation)
- Faça upload do arquivo final para um dataset **PRIVADO** em [huggingface.co/somosnlp-hackathon-2026](https://huggingface.co/somosnlp-hackathon-2026) com o nome do exame. Se você não faz parte da organização, junte-se com este [convite](https://huggingface.co/somosnlp-hackathon-2026).
