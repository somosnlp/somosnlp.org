...
- El equipo debe contribuir en total 100 prompts **de calidad** al dataset de preferencias y 200 respuestas al dataset de evaluación ([BLEND](https://somosnlp.org/hackathon-2025/retos/blend))
...
- No incluyas estereotipos: para tratar este tema participa en el reto del [Validador de estereotipos](https://somosnlp.org/hackathon-2025/retos/estereotipos).
...
- El lunes 21 publicaremos el conjunto de preguntas y respuestas para que lo podáis utilizar para alinear vuestros LLMs. También incluiremos los datos del mini reto “[Validador de estereotipos](https://somosnlp.org/hackathon-2025/retos/estereotipos)”.
...
- Recuerda que también puedes participar en los mini retos para conseguir más puntos
    - [INCLUDE](https://somosnlp.org/hackathon-2025/retos/include) - Recolección de exámenes (hasta el 30 de abril, habrá premios y paper)
    - [BLEND](https://somosnlp.org/hackathon-2025/retos/blend) - Preguntas de conocimiento cultural (hasta el final del hackathon, habrá paper)
