...
<div style="display: flex; justify-content: center; gap: 20px;">
  ...
  <a href="https://forms.gle/i1MG2F1BGZSg2CpR6" target="_blank" style="background-color:#FACC15; color:white; padding:10px 20px; text-decoration:none; border-radius:5px;">📣 Help us spread the word</a>
</div>
...
- **🥇 Gold**, total donation valued at €2,500: large logo in first place, maximum visibility on social media, mention at events and a possible promotional article, video or talk.
- **🥈 Silver**, total donation valued at €1,200: medium logo in second place, medium visibility on social media and a possible promotional article or video.
- **🥉 Bronze**, total donation valued at €600: medium logo in third place and visibility on social media.
...
- Cloud compute time for all participants
...
- The first publication must go out before May 1.
- The logo will be added to the hackathon website once the first publication is live.
...
| | Gold | Silver | Bronze | Outreach |
|-| --------|-------|--------|-----------|
| Logo on the hackathon website and the registration page | ✅ L | ✅ M | ✅ M | ✅ S |
| Logo on the "Community" page (order) | ✅ 1st | ✅ 2nd | ✅ 3rd | ✅ 4th |
| Acknowledgment on social media and collaboration announcement | ✅ | ✅ | ✅ | ✅ |
| Tags in posts (minimum) | ✅ 15 | ✅ 15 | ✅ 10 | ✅ 5 | 
| Social media post presenting your mission and projects | ✅ In+X | ✅ In+X | ✅ X | ❌ |
| Mention in an article describing the sponsorships | ✅ | ✅ | ✅ | ❌ |
| Live mention during the opening and closing | ✅ | ✅ | ❌ | ❌ |
