---
title: "Main Challenge #HackathonSomosNLP 2025: LLM and VLLM Alignment"
...
- Upload the dataset to hf.co/somosnlp-hackathon-2025 and iterate
...
1. Create a Space in the organization hf.co/somosnlp-hackathon-2025 with the [JupyterLab](https://huggingface.co/docs/hub/spaces-sdks-docker-jupyter) template
...
3. Design the training notebook
    - Save the resulting model directly to hf.co/somosnlp-hackathon-2025
