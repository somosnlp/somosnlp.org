...
<template>
    <div class="rounded-md grid p-4 gap-4 grid-cols-[auto,1fr,auto]" hover="bg-gray-50 dark:bg-gray-800">
        ...
        <div class="grid gap-2">
            <div class="flex flex-wrap gap-2 justify-self-end items-center" text="lg">
                ...
                <IconButtonLink v-if="hf_dataset_name" :url="'https://huggingface.co/datasets/' + hf_dataset_name"
                    class="contents">
                    <noto:hugging-face />
                </IconButtonLink>
                <IconButtonLink v-if="hf_model_name"
                    :url="'https://huggingface.co/' + hf_contributor_handle + '/' + hf_model_name" class="contents">
                    <noto:hugging-face />
                </IconButtonLink>
            </div>
            <a v-if="hf_contributor_handle" :href="'https://hf.co/' + hf_contributor_handle" target="_blank"
